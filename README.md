...
Build a cross-platform Book List application built with .NET MAUI using SQLite to persist the data.
It keeps clean architecture principles like MVVM and a modern UI layout.
## Concepts Applied
